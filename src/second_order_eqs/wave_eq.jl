...
function semidiscretize(du0func,
                        u0func,
                        semi::WaveEquationNonperiodicSemidiscretization,
                        tspan)
...
function (disc::WaveEquationNonperiodicSemidiscretization)(ddu, du, u, p, t)
    ...
    elseif left_bc == Val(:HomogeneousDirichlet)
        mul_transpose_derivative_left!(ddu,
                                       derivative,
                                       Val(1),
                                       -u[1] / left_boundary_weight(derivative),
                                       true)
    ...
    elseif right_bc == Val(:HomogeneousDirichlet)
        mul_transpose_derivative_right!(ddu,
                                        derivative,
                                        Val(1),
                                        u[end] / right_boundary_weight(derivative),
                                        true)
