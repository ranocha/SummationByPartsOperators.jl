...
function first_derivative_coefficients(
    ...
    if order == 2
        left_boundary_plus = (
            DerivativeCoefficientRow{T,1,3}(SVector(T(-3), T(5), T(-2))),
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(-1 // 5), T(-1), T(8 // 5), T(-2 // 5)),
            ),
        )
        right_boundary_plus = (
    ...
    elseif order == 3
        left_boundary_plus = (
            DerivativeCoefficientRow{T,1,3}(SVector(T(-7 // 5), T(9 // 5), T(-2 // 5))),
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(-5 // 13), T(-5 // 13), T(12 // 13), T(-2 // 13)),
            ),
        )
        right_boundary_plus = (
            DerivativeCoefficientRow{T,1,2}(SVector(T(1), T(-1))),
            DerivativeCoefficientRow{T,1,3}(SVector(T(9 // 13), T(-5 // 13), T(-4 // 13))),
        )
    ...
    elseif order == 4
        left_boundary_plus = (
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(-75 // 49), T(205 // 98), T(-29 // 49), T(3 // 98)),
            ),
        ...
        right_boundary_plus = (
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(69 // 49), T(-169 // 98), T(11 // 49), T(9 // 98)),
            ),
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(205 // 366), T(-11 // 61), T(-39 // 122), T(-11 // 183)),
            ),
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(-29 // 123), T(99 // 82), T(-29 // 41), T(-65 // 246)),
            ),
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(3 // 298),
    ...
    elseif order == 5
        left_boundary_plus = (
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(-366 // 251), T(941 // 502), T(-94 // 251), T(-21 // 502)),
            ),
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(-869 // 1794),
        ...
        right_boundary_plus = (
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(354 // 251), T(-869 // 502), T(58 // 251), T(45 // 502)),
            ),
            DerivativeCoefficientRow{T,1,4}(
                SVector(T(941 // 1794), T(-22 // 299), T(-255 // 598), T(-22 // 897)),
            ),
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(-94 // 633),
    ...
    elseif order == 8
        left_boundary_plus = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-87682997519961 // 198485864362786),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(20045516300728 // 83364187761855),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    T(118016946570403 // 1404599159063100),
            ...
            DerivativeCoefficientRow{T,1,11}(
                SVector(
                    T(-4975275570026 // 83211286617459),
            ...
            DerivativeCoefficientRow{T,1,12}(
                SVector(
                    T(-2164019088443 // 360119721423462),
            ...
            DerivativeCoefficientRow{T,1,13}(
                SVector(
                    T(18967504495373 // 1312833690376780),
        ...
        right_boundary_plus = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(88037468909961 // 198485864362786),
                    T(-5599612620 // 1090581672323),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-21877003412728 // 83364187761855),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    T(-113480208109603 // 1404599159063100),
            ...
            DerivativeCoefficientRow{T,1,11}(
                SVector(
                    T(5001038984066 // 83211286617459),
            ...
            DerivativeCoefficientRow{T,1,12}(
                SVector(
                    T(2235718279643 // 360119721423462),
            ...
            DerivativeCoefficientRow{T,1,13}(
                SVector(
                    T(-19035612535373 // 1312833690376780),
        ...
        upper_coef_plus =
            SVector(T(5 // 4), T(-1 // 2), T(1 // 6), T(-1 // 28), T(1 // 280))
    ...
    elseif order == 9
        left_boundary_plus = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-12536394187263 // 28351436894638),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(2906875120024 // 11936819073465),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    T(16773595838149 // 200546425150500),
            ...
            DerivativeCoefficientRow{T,1,13}(
                SVector(
                    T(2714455026059 // 187542403502740),
        ...
        right_boundary_plus = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(12558900307263 // 28351436894638),
                    T(-2488716720 // 1090439880563),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-3023160016024 // 11936819073465),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-16485548951749 // 200546425150500),
            ...
            DerivativeCoefficientRow{T,1,12}(
                SVector(
                    T(-2718779346059 // 187542403502740),
        ...
        upper_coef_plus =
            SVector(T(1 // 1), T(-1 // 3), T(2 // 21), T(-1 // 56), T(1 // 630))
