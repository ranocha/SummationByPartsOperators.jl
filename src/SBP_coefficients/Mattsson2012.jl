...
function convolve_boundary_coefficients!(dest::AbstractVector, cache::Mattsson2012Cache6,
    ...
    @inbounds begin
        ...
        dest[  8] = α * (
                        ...
                        + (d081010*b[10] + d081008*b[ 8] + d081009*b[ 9]) * u[10]
                        + (d081111*b[11] + d081108*b[ 8]) * u[11]
        )
        dest[  9] = α * (
                        ...
                        + (d091010*b[10] + d091011*b[11] + d091008*b[ 8] + d091009*b[ 9]) * u[10]
                        + (d091110*b[10] + d091111*b[11] + d091109*b[ 9]) * u[11]
