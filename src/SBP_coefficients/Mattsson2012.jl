...
struct Mattsson2012Cache6{T} <: AbstractCoefficientCache{T}
    ...
    function Mattsson2012Cache6(::Type{T}) where {T}
        ...
        d010501 = T(-5339411064665444794491//8530625000000000000000)
        ...
        d070604, d070605, d070606, d070607, d070608, 
        d070704, d070705, d070706, d070707, d070708, 
        d070805, d070806, d070807, d070808, d070809, 
        d070905, d070906, d070907, d070908, d070909, 
        d071010, d071007, 
        ...
        d080605, d080606, d080607, d080608, 
        d080705, d080706, d080707, d080708, d080709, 
        d080805, d080806, d080807, d080808, d080809, 
        d080910, d080905, d080906, d080907, d080908, d080909, 
        ...
        d090705, d090706, d090707, d090708, d090709, 
        d090810, d090805, d090806, d090807, d090808, d090809, 
...
function convolve_boundary_coefficients!(dest::AbstractVector, cache::Mattsson2012Cache6,
    ...
    @inbounds begin
        ...
        dest[  7] = α * (
                        ...
                        + (d070604*b[ 4] + d070605*b[ 5] + d070606*b[ 6] + d070607*b[ 7] + d070608*b[ 8]) * u[ 6]
                        + (d070704*b[ 4] + d070705*b[ 5] + d070706*b[ 6] + d070707*b[ 7] + d070708*b[ 8]) * u[ 7]
                        + (d070805*b[ 5] + d070806*b[ 6] + d070807*b[ 7] + d070808*b[ 8] + d070809*b[ 9]) * u[ 8]
                        + (d070905*b[ 5] + d070906*b[ 6] + d070907*b[ 7] + d070908*b[ 8] + d070909*b[ 9]) * u[ 9]
        ...
        dest[  8] = α * (
                        ...
                        + (d080605*b[ 5] + d080606*b[ 6] + d080607*b[ 7] + d080608*b[ 8]) * u[ 6]
                        + (d080705*b[ 5] + d080706*b[ 6] + d080707*b[ 7] + d080708*b[ 8] + d080709*b[ 9]) * u[ 7]
                        + (d080805*b[ 5] + d080806*b[ 6] + d080807*b[ 7] + d080808*b[ 8] + d080809*b[ 9]) * u[ 8]
                        + (d080910*b[10] + d080905*b[ 5] + d080906*b[ 6] + d080907*b[ 7] + d080908*b[ 8] + d080909*b[ 9]) * u[ 9]
        ...
        dest[  9] = α * (
                        ...
                        + (d090705*b[ 5] + d090706*b[ 6] + d090707*b[ 7] + d090708*b[ 8] + d090709*b[ 9]) * u[ 7]
                        + (d090810*b[10] + d090805*b[ 5] + d090806*b[ 6] + d090807*b[ 7] + d090808*b[ 8] + d090809*b[ 9]) * u[ 8]
                        + (d090910*b[10] + d090905*b[ 5] + d090906*b[ 6] + d090907*b[ 7] + d090908*b[ 8] + d090909*b[ 9]) * u[ 9]
