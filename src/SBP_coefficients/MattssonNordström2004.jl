...
function Base.show(io::IO, source::MattssonNordström2004)
...
function first_derivative_coefficients(source::MattssonNordström2004,
                                       order::Int,
                                       T = Float64,
                                       mode = FastMode())
    if order == 2
...
function second_derivative_coefficients(source::MattssonNordström2004,
                                        order::Int,
                                        T = Float64,
                                        mode = FastMode())
    if order == 2
