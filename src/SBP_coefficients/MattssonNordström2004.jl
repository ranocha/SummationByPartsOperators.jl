...
function first_derivative_coefficients(source::MattssonNordström2004, order::Int,
...
function second_derivative_coefficients(source::MattssonNordström2004, order::Int,
                                        T = Float64, mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
