...
function dissipation_coefficients(source::MattssonSvärdNordström2004, order::Int,
                                  grid, left_weights, right_weights, mode = FastMode())
    ...
    VarCoefDerivativeCoefficients(coefficient_cache, left_weights, right_weights, mode,
                                  order, 2, source), b
end
...
function convolve_boundary_coefficients!(dest::AbstractVector,
    ...
    @inbounds begin
        dest[1] = α * inv_left_weights[1] * ((b[1] + b[2]) * u[1]
                                             +
                                             (b[1] - b[2]) * u[2])
        ...
        dest[end] = α * inv_right_weights[1] * (b[end] * u[end]
                                                -
                                                b[end] * u[end - 1])
        ...
        for i in 3:length(inv_left_weights)
            dest[i] = α * inv_left_weights[i] *
                      (-b[i] * u[i - 1]
                       ...
                       (b[i] + b[i + 1]) * u[i]
                       -
                       b[i + 1] * u[i + 1]) + β * dest[i]
        end

        dest[end] = α * inv_right_weights[1] * (b[end] * u[end]
                                                -
                                                b[end] * u[end - 1]) + β * dest[end]
        dest[end - 1] = α * inv_right_weights[2] *
                        (-b[end - 1] * u[end - 2]
                         +
                         (b[end - 1] + b[end]) * u[end - 1]
                         -
                         b[end] * u[end]) + β * dest[end - 1]
        for i in 2:(length(inv_right_weights) - 1)
            dest[end - i] = α * inv_right_weights[i + 1] *
                            (-b[end - i] * u[end - (i - 1)]
                             +
    ...
    @inbounds begin
        ...
        dest[end - 3] = α * inv_right_weights[4] *
                        (4 * (b[end - 2] + b[end - 1] + b[end]) * u[end]
                         ...
                         (b[end - 4] + 6 * b[end - 3] + 6 * b[end - 2] + 6 * b[end - 1] +
                          6 * b[end]) * u[end - 2]
                         -
                         (b[end - 5] + 16 * b[end - 4] + 36 * b[end - 3] + 16 * b[end - 2] +
                          16 * b[end - 1] + 16 * b[end]) * u[end - 3]
                         +
                         4 *
                         (b[end - 5] + 6 * b[end - 4] + 6 * b[end - 3] + b[end - 2] +
                          b[end - 1] + b[end]) * u[end - 4]
                         -
        ...
        dest[end - 4] = α * inv_right_weights[5] *
                        (-(b[end - 2] + b[end - 1] + b[end]) * u[end]
                         ...
                         -
                         (6 * b[end - 4] + 16 * b[end - 3] + 6 * b[end - 2] +
                          6 * b[end - 1] + 6 * b[end]) * u[end - 2]
                         +
                         4 *
                         (b[end - 5] + 6 * b[end - 4] + 6 * b[end - 3] + b[end - 2] +
                          b[end - 1] + b[end]) * u[end - 3]
                         -
                         (b[end - 6] + 16 * b[end - 5] + 36 * b[end - 4] + 16 * b[end - 3] +
                          b[end - 2] + b[end - 1] + b[end]) * u[end - 4]
                         +
            ...
            dest[end - i] = α * inv_right_weights[i + 1] *
                            (-b[end - (i + 2)] * u[end - (i + 4)]
                             ...
                             (b[end - (i + 2)] + 6 * b[end - (i + 1)] + 6 * b[end - i] +
                              b[end - (i - 1)]) * u[end - (i + 1)]
                             -
                             (b[end - (i + 2)] + 16 * b[end - (i + 1)] + 36 * b[end - i] +
                              16 * b[end - (i - 1)] + b[end - (i - 2)]) * u[end - i]
                             +
                             4 *
...
function first_derivative_coefficients(source::MattssonSvärdNordström2004, order::Int,
...
function second_derivative_coefficients(source::MattssonSvärdNordström2004, order::Int,
                                        T = Float64, mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
