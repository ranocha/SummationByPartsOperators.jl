...
function first_derivative_coefficients(
    source::DienerDorbandSchnetterTiglio2007,
    order::Int,
    T = Float64,
    mode = FastMode(),
)
    ...
    elseif order == 6
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,6}(
                SVector(
                    convert(T, big"-1.582533518939116418785258993332844897062"),
            ...
            DerivativeCoefficientRow{T,1,6}(
                SVector(
                    convert(T, big"-0.4620701275035953590186631853846278325646"),
                    convert(T, 0),
            ...
            DerivativeCoefficientRow{T,1,6}(
                SVector(
                    convert(T, big"0.07134398748360337973038301686379010397038"),
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    convert(T, big"0.1146397975178068401430112823144985150596"),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    convert(T, big"-0.03614399304268576976452921364705641609825"),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    convert(T, big"-0.01141318406360863692889821914555232596651"),
    ...
    elseif order == 8
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    convert(T, big"-1.695543604431898508749855654248370812054"),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    convert(T, big"-0.4338209217401506177055540526837828066711"),
                    convert(T, 0),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    convert(T, big"0.002477771724790106958560398469919805908522"),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    convert(T, big"0.1470043328582935680963279007411074464266"),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    convert(T, big"-0.1624073990846984662267508265053107632238"),
            ...
            DerivativeCoefficientRow{T,1,10}(
                SVector(
                    convert(T, big"-0.03609686950604370828405582087760384548297"),
            ...
            DerivativeCoefficientRow{T,1,11}(
                SVector(
                    convert(T, big"-0.0009797678134978722516935350416937185004514"),
            ...
            DerivativeCoefficientRow{T,1,12}(
                SVector(
                    convert(T, big"0.01090012273307913185972171872891927027272"),
