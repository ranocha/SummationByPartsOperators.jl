...
function first_derivative_coefficients(source::Mattsson2014, order::Int, T = Float64,
                                       mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
...
function second_derivative_coefficients(source::Mattsson2014, order::Int, T = Float64,
                                        mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
...
function third_derivative_coefficients(source::Mattsson2014, order::Int, T = Float64,
                                       mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
...
function fourth_derivative_coefficients(source::Mattsson2014, order::Int, T = Float64,
                                        mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
