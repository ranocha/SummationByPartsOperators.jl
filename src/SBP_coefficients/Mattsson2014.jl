...
function first_derivative_coefficients(source::Mattsson2014,
                                       order::Int,
                                       T = Float64,
                                       mode = FastMode())
    if order == 2
    ...
    elseif order == 6
        left_boundary = (
                         ...
                         # d2
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(-4642075227 //
                                                                     10228748530),
                                                                   T(0),
                         ...
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(45621684 // 696580885),
                                                                   ...
                                                                   T(-1686470 // 139316177))),
                         # d4
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(1002751721 //
                                                                     11591207628),
                         ...
                         DerivativeCoefficientRow{T, 1, 9}(SVector(T(-2047730 // 52061009),
                                                                   ...
                                                                   T(4032 // 260045))),
                         # d7
                         DerivativeCoefficientRow{T, 1, 10}(SVector(T(-291943739 //
                                                                      21305233950),
                                                                    T(720387 // 31216460),
                                                                    ...
                                                                    T(12096 // 709465))),
                         # d8
                         DerivativeCoefficientRow{T, 1, 11}(SVector(T(10874619 //
                                                                      1121684300),
                                                                    T(-538846039 //
                                                                      21872843850),
                                                                    T(1011882 // 145818959),
...
function second_derivative_coefficients(source::Mattsson2014,
                                        order::Int,
                                        T = Float64,
                                        mode = FastMode())
    if order == 2
    ...
    elseif order == 6
        left_boundary = (
                         # d1
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(24055498439 //
                                                                     8194715100),
                                                                   T(-9925742373 //
                                                                     1138154875),
                         ...
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(-2479644 // 63325535),
                                                                   ...
                                                                   T(-41036 // 10716629))),
                         # d4
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(-1092927401 //
                                                                     17386811442),
                                                                   ...
                                                                   T(-37555785 //
                                                                     3863735876))),
                         # d5
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(-54436269 //
                                                                     2376281908),
                         ...
                         DerivativeCoefficientRow{T, 1, 9}(SVector(T(4575268 // 260305045),
                                                                   ...
                                                                   T(2688 // 260045))),
                         # d7
                         DerivativeCoefficientRow{T, 1, 10}(SVector(T(355447739 //
                                                                      63915701850),
                                                                    T(-9667431 //
                                                                      1014534950),
                                                                    T(-22525209 //
                                                                    ...
                                                                    T(8064 // 709465))),
                         # d8
                         DerivativeCoefficientRow{T, 1, 11}(SVector(T(-24731721 //
                                                                      7290947950),
                                                                    T(634102039 //
                                                                      65618531550),
                                                                    T(-123108 // 56084215),
...
function third_derivative_coefficients(source::Mattsson2014,
                                       order::Int,
                                       T = Float64,
                                       mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
                         DerivativeCoefficientRow{T, 1, 4}(SVector(T(1 // 4), T(-5 // 8),
                                                                   T(1 // 2), T(-1 // 8))),
                         # d2
                         DerivativeCoefficientRow{T, 1, 4}(SVector(T(-11 // 16), T(2),
                                                                   T(-31 // 16), T(5 // 8))),
                         # d3
                         DerivativeCoefficientRow{T, 1, 5}(SVector(T(-1 // 2), T(15 // 16),
                                                                   T(1 // 8), T(-17 // 16),
                                                                   T(1 // 2))))
        right_boundary = .-left_boundary
        ...
        left_boundary_derivatives = (
                                     ...
                                     DerivativeCoefficientRow{T, 1, 3}(SVector(T(-3 // 2),
                                                                               ...
                                                                               T(-1 // 2))),
                                     # second derivative
                                     DerivativeCoefficientRow{T, 1, 3}(SVector(T(1), T(-2),
                                                                               T(1))))
        right_boundary_derivatives = (-left_boundary_derivatives[1],
    ...
    elseif order == 4
        ...
        left_boundary_derivatives = (
                                     ...
                                     DerivativeCoefficientRow{T, 1, 4}(SVector(T(-11 / 6),
                                                                               ...
                                                                               T(1 // 3))),
                                     # second derivative
                                     DerivativeCoefficientRow{T, 1, 4}(SVector(T(2), T(-5),
                                                                               T(4), T(-1))))
        right_boundary_derivatives = (-left_boundary_derivatives[1],
                                      left_boundary_derivatives[2])
    ...
    elseif order == 6
        left_boundary = (
                         ...
                         # d2
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(-13333381409 //
                                                                     8182998824),
                                                                   T(829440 // 145979),
                                                                   T(-8702160983 //
                                                                     1168999832),
                         ...
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(14062931 // 75990642),
                                                                   ...
                                                                   T(343537955 //
                                                                     3343588248))),
                         # d4
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(661223855 //
                                                                     7727471752),
                                                                   T(-214194059 //
                                                                     275981134),
                                                                   T(1209539129 //
                         ...
                         DerivativeCoefficientRow{T, 1, 9}(SVector(T(-91064195 // 594070477),
                                                                   ...
                                                                   T(21168 // 593477))),
                         # d6
                         DerivativeCoefficientRow{T, 1, 10}(SVector(T(11473393 //
                                                                      1249464216),
                                                                    T(-8685103 // 111559305),
                                                                    T(116503713 //
                                                                      297491480),
                                                                    ...
                                                                    T(7056 // 260045))),
                         # d7
                         DerivativeCoefficientRow{T, 1, 11}(SVector(T(38062741 //
                                                                      1420348930),
                                                                    T(-20422191 //
                                                                      162325592),
                                                                    ...
                                                                    T(21168 // 709465))),
                         # d8
                         DerivativeCoefficientRow{T, 1, 12}(SVector(T(-40315779 //
                                                                      5832758360),
                                                                    T(50022767 //
                                                                      1458189590),
                                                                    T(-68707591 //
...
function fourth_derivative_coefficients(source::Mattsson2014,
                                        order::Int,
                                        T = Float64,
                                        mode = FastMode())
    if order == 2
        left_boundary = (
                         # d1
                         DerivativeCoefficientRow{T, 1, 4}(SVector(T(8 // 5), T(-24 // 5),
                                                                   T(24 // 5), T(-8 // 5))),
                         # d2
                         DerivativeCoefficientRow{T, 1, 4}(SVector(T(-2 // 5), T(6 // 5),
                                                                   T(-6 // 5), T(2 // 5))),
                         # d3
                         DerivativeCoefficientRow{T, 1, 5}(SVector(T(2 // 5), T(-11 // 5),
                                                                   T(21 // 5), T(-17 // 5),
                                                                   T(1))),
                         # d4
                         DerivativeCoefficientRow{T, 1, 6}(SVector(T(1 // 5), T(2 // 5),
                                                                   T(-17 // 5), T(29 // 5),
                                                                   T(-4), T(1))))
        right_boundary = left_boundary
        ...
        left_boundary_derivatives = (
                                     ...
                                     DerivativeCoefficientRow{T, 1, 3}(SVector(T(1), T(-2),
                                                                               T(1))),
                                     # third derivative
                                     DerivativeCoefficientRow{T, 1, 4}(SVector(T(-1), T(3),
                                                                               T(-3), T(1))))
        right_boundary_derivatives = (-left_boundary_derivatives[1],
                                      left_boundary_derivatives[2],
    ...
    elseif order == 6
        left_boundary = (
                         # d1
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(37567391168 //
                                                                     53948541075),
                                                                   T(-95834307667 //
                                                                     35965694050),
                                                                   ...
                                                                   T(134156001 //
                                                                     7193138810))),
                         # d2
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(29125918379 //
                                                                     23087746682),
                                                                   T(-1255810938848 //
                                                                     242421340161),
                                                                   T(1289206067431 //
                                                                   ...
                                                                   T(334788562 //
                                                                     242421340161))),
                         # d3
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(1308658570 //
                                                                     3001630359),
                                                                   T(-88210933529 //
                                                                     66035867898),
                                                                   T(13622370452 //
                                                                   ...
                                                                   T(-928716467 //
                                                                     9433695414))),
                         # d4
                         DerivativeCoefficientRow{T, 1, 8}(SVector(T(110582060185 //
                                                                     457852701306),
                                                                   T(-22954806538 //
                                                                     76308783551),
                                                                   T(-180184675067 //
                                                                   ...
                                                                   T(4720003312 //
                                                                     76308783551))),
                         # d5
                         DerivativeCoefficientRow{T, 1, 9}(SVector(T(1870177580 //
                                                                     46931567683),
                                                                   T(-21945155863 //
                                                                     281589406098),
                                                                   T(45403496174 //
                                                                   ...
                                                                   T(21168 // 593477))),
                         # d6
                         DerivativeCoefficientRow{T, 1, 10}(SVector(T(-15248255797 //
                                                                      123384591330),
                                                                    T(31446420748 //
                                                                      61692295665),
                                                                    T(-26412188989 //
                                                                    ...
                                                                    T(7056 // 260045))),
                         # d7
                         DerivativeCoefficientRow{T, 1, 11}(SVector(T(690313814 //
                                                                      24044478315),
                                                                    T(-21701585799 //
                                                                      112207565470),
                                                                    T(21399717536 //
                                                                    ...
                                                                    T(21168 // 709465))),
                         # d8
                         DerivativeCoefficientRow{T, 1, 12}(SVector(T(134156001 //
                                                                      23039395522),
                                                                    T(334788562 //
                                                                      172795466415),
                                                                    T(-6501015269 //
