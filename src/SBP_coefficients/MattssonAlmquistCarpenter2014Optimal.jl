...
function MattssonAlmquistCarpenter2014OptimalGrid(xmin::T,
                                                  xmax::T,
                                                  d1::T,
                                                  d2::T,
                                                  d3::T,
    ...
    MattssonAlmquistCarpenter2014OptimalGrid{T, typeof(uniform_grid)}(xmin,
                                                                      xmax,
                                                                      d1,
                                                                      d2,
                                                                      d3,
...
function construct_grid(::MattssonAlmquistCarpenter2014Optimal,
                        accuracy_order,
                        xmin,
                        xmax,
                        N)
