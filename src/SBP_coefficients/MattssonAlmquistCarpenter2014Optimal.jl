...
function MattssonAlmquistCarpenter2014OptimalGrid(
    xmin::T,
    xmax::T,
    d1::T,
    d2::T,
    ...
    MattssonAlmquistCarpenter2014OptimalGrid{T,typeof(uniform_grid)}(
        xmin,
        xmax,
        d1,
        d2,
...
function first_derivative_coefficients(
    ...
    if order == 2
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,3}(
                SVector(
                    T(-50000000000000000000 // 33743097329453577701),
            ...
            DerivativeCoefficientRow{T,1,4}(
                SVector(
                    T(2966241594385205626 // 46639404052015171765),
        ...
        left_weights = SVector(
            T(33743097329453577701 // Int128(10)^20),
    ...
    elseif order == 4
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(-50000000000000000000 // 21427296612044126417),
            ...
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(-16721224671732595127 // 28093989712218483700),
                    T(0),
            ...
            DerivativeCoefficientRow{T,1,5}(
                SVector(
                    T(12585765939376928119 // 71722939624706300000),
            ...
            DerivativeCoefficientRow{T,1,6}(
                SVector(
                    T(-10997619816825822803 // 109173230217361308360),
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    T(2259155520835289216 // 82365134292746683125),
        ...
        lower_coef = -upper_coef
        left_weights = SVector(
            T(21427296612044126417 // 100000000000000000000),
    ...
    elseif order == 6
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    T(-3125000000000000000 // 944357158252257333),
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    T(-22223596967296279011 // 26989195119035671001),
                    T(0),
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    T(5854697895099786871 // 27278567870198137125),
            ...
            DerivativeCoefficientRow{T,1,7}(
                SVector(
                    T(-84251264588860596867 // 1043526904157157775600),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(1592329083817967435 // 98680905919946100728),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    T(15653772860347171721 // 10037581831426163456000),
            ...
            DerivativeCoefficientRow{T,1,10}(
                SVector(
                    T(-71741032045689717567 // 99943556356761752125000),
        ...
        lower_coef = -upper_coef
        left_weights = SVector(
            T(944357158252257333 // 6250000000000000000),
