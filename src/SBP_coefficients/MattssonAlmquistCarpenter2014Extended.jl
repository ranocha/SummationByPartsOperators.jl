...
function first_derivative_coefficients(source::MattssonAlmquistCarpenter2014Extended,
    ...
    if order == 2
        left_boundary = (
                         # d1
                         DerivativeCoefficientRow{T, 1, 3}(SVector(T(-6 // 5), T(7 // 5),
                                                                   T(-1 // 5))),
                         # d2
                         DerivativeCoefficientRow{T, 1, 3}(SVector(T(-1 // 2), T(0),
                                                                   T(1 // 2))),
                         # d3
                         DerivativeCoefficientRow{T, 1, 4}(SVector(T(1 // 11), T(-7 // 11),
                                                                   T(0), T(6 // 11))))
        right_boundary = .-left_boundary
        upper_coef = SVector(T(1 // 2))
        central_coef = zero(T)
        lower_coef = -upper_coef
        left_weights = SVector(T(5 // 12), T(7 // 6), T(11 // 12))
    ...
    elseif order == 6
        left_boundary = (
                         ...
                         DerivativeCoefficientRow{T, 1, 9}(SVector(T(-45360 // 513973),
                                                                   ...
                                                                   T(6720 // 513973))),
                         # d7
                         DerivativeCoefficientRow{T, 1, 10}(SVector(T(39279943 //
                                                                      1409459100),
                                                                    T(-23380423 //
                                                                      281891820),
                                                                    T(508309 // 23490985),
