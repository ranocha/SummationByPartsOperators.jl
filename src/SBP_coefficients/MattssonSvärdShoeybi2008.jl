...
function first_derivative_coefficients(
    ...
    elseif order == 8
        left_boundary = (
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-515174618457408334671 // 420776658856749814780),
                    T(0),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(106551148653356045477 // 4733507987139058764),
            ...
            DerivativeCoefficientRow{T,1,8}(
                SVector(
                    T(-1756838164798071830975 // 297539771191584439476),
            ...
            DerivativeCoefficientRow{T,1,9}(
                SVector(
                    T(132855587210457907869 // 5691012984537517679),
            ...
            DerivativeCoefficientRow{T,1,10}(
                SVector(
                    T(-9763428116329763441 // 3358016562304840404),
            ...
            DerivativeCoefficientRow{T,1,12}(
                SVector(
                    T(13621478277275954493 // 55672594705880416916),
