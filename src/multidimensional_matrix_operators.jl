...
"""
@auto_hash_equals struct MultidimensionalMatrixDerivativeOperator{Dim,
                                                                  T,
                                                                  NodesType,
                                                                  DType <:
                                                                  AbstractMatrix{T},
    ...
    function MultidimensionalMatrixDerivativeOperator(nodes::NodesType,
        ...
        new{Dim, T, NodesType, DType, SourceOfCoefficients}(nodes,
                                                            boundary_indices,
                                                            normals,
                                                            weights,
                                                            weights_boundary,
...
"""
function integrate_boundary(func,
                            u,
