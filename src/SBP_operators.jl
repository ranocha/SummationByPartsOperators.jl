...
"""
@auto_hash_equals struct DerivativeCoefficients{T,
                                                LeftBoundary,
                                                RightBoundary,
    ...
    function DerivativeCoefficients(left_boundary::LeftBoundary,
        ...
        new{T,
            ...
            RightWidth,
            ExecutionMode,
            SourceOfCoefficients}(left_boundary,
                                  right_boundary,
...
@inline function convolve_left_row(coef_row::DerivativeCoefficientRow{T, Start, Length},
                                   u,
...
@inline function convolve_right_row(coef_row::DerivativeCoefficientRow{T, Start, Length},
                                    u,
                                    ::SafeMode) where {T, Start, Length}
...
@unroll function convolve_boundary_coefficients!(dest::AbstractVector,
                                                 left_boundary,
                                                 right_boundary,
                                                 u::AbstractVector,
                                                 α,
...
"""
@auto_hash_equals struct DerivativeOperator{T,
                                            LeftBoundary,
                                            RightBoundary,
                                            LeftBoundaryDerivatives,
                                            RightBoundaryDerivatives,
    ...
    coefficients::DerivativeCoefficients{T,
                                         LeftBoundary,
                                         RightBoundary,
                                         LeftBoundaryDerivatives,
                                         RightBoundaryDerivatives,
    ...
    function DerivativeOperator(coefficients::DerivativeCoefficients{T,
                                                                     LeftBoundary,
                                                                     RightBoundary,
                                                                     LeftBoundaryDerivatives,
                                                                     RightBoundaryDerivatives,
...
@inline function derivative_left(D::AbstractNonperiodicDerivativeOperator,
                                 u,
                                 der_order::Val{0})
    u[begin]
end
...
@inline function derivative_right(D::DerivativeOperator, u, der_order::Val{N}) where {N}
    convolve_right_row(D.coefficients.right_boundary_derivatives[N],
                       u,
                       D.coefficients.mode) / D.Δx^N
end

@inline function derivative_right(D::AbstractNonperiodicDerivativeOperator,
                                  u,
                                  der_order::Val{0})
    u[end]
end
...
"""
@inline function mul_transpose_derivative_left!(u::AbstractVector,
...
Thus, the coefficients `α, β` have the same meaning as in [`mul!`](@ref).
"""
@inline function mul_transpose_derivative_right!(u::AbstractVector,
                                                 D::DerivativeOperator,
                                                 der_order::Val{N},
                                                 α = true,
                                                 β = false) where {N}
...
function derivative_operator(source_of_coefficients,
    ...
    if derivative_order == 1
        coefficients = first_derivative_coefficients(source_of_coefficients,
                                                     accuracy_order,
                                                     eltype(grid),
                                                     mode)
    ...
    elseif derivative_order == 3
        coefficients = third_derivative_coefficients(source_of_coefficients,
                                                     accuracy_order,
                                                     eltype(grid),
                                                     mode)
