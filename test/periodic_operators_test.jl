...
let T = Float32
    ...
    derivative_order = 1
    accuracy_order = 2
    D = periodic_central_derivative_operator(derivative_order,
                                             accuracy_order,
                                             xmin,
                                             xmax,
                                             N)
    ...
    accuracy_order = 2
    @test_throws ArgumentError periodic_central_derivative_operator(4,
                                                                    accuracy_order,
                                                                    xmin,
                                                                    xmax,
                                                                    N)
    @test_throws ArgumentError periodic_central_derivative_operator(5,
                                                                    accuracy_order,
                                                                    xmin,
                                                                    xmax,
                                                                    N)
    @test_throws ArgumentError periodic_central_derivative_operator(6,
                                                                    accuracy_order,
                                                                    xmin,
                                                                    xmax,
                                                                    N)
...
for T in (Float32, Float64), accuracy_order in 2:2:12, derivative_order in 1:3
    ...
    xmax = one(T)
    N = 21
    D_central = periodic_central_derivative_operator(derivative_order,
                                                     accuracy_order,
                                                     xmin,
                                                     xmax,
                                                     N)
...
for T in (Float32, Float64), accuracy_order in 1:10, derivative_order in 1:3
    ...
    D_threads = periodic_derivative_operator(derivative_order,
                                             accuracy_order,
                                             xmin,
                                             xmax,
                                             N,
...
for T in (Float32, Float64), accuracy_order in 1:10, derivative_order in 1:3
    ...
    D_threads = periodic_derivative_operator(derivative_order,
                                             ...
                                             N,
                                             ThreadedMode())
    D_safe = periodic_derivative_operator(derivative_order,
                                          accuracy_order,
                                          xmin,
                                          xmax,
                                          N,
...
let T = Float32
    ...
    for stencil_width in 5:2:11
        D = periodic_derivative_operator(Holoborodko2008(),
                                         der_order,
                                         acc_order,
                                         xmin,
                                         xmax,
    ...
    @test_throws ArgumentError D=periodic_derivative_operator(Holoborodko2008(),
                                                              der_order,
                                                              acc_order,
                                                              xmin,
                                                              xmax,
...
let N = 4
    @test_throws ArgumentError periodic_derivative_operator(1,
                                                            2,
                                                            0 // 1,
                                                            (N - 1) // 1,
                                                            N,
