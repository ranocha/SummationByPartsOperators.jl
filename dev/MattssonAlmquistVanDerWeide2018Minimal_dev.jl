...
# order 4
h = [2.6864248295847e-01, 1.0094667153500e+00, 9.9312068011715e-01, 1, 1, 1, 1, 1]
e = [1 // 1, 0, 0, 0, 0, 0, 0, 0]
H = Diagonal(h)

q1 = [0, 6.1697245625434e-01, -1.1697245625434e-01, 0.0000000000000e+00, 0, 0, 0, 0]'
q2 = [-q1[2], 0, 7.0030578958767e-01, -8.3333333333333e-02, 0.0000000000000e+00, 0, 0, 0]'
q3 = [-q1[3], -q2[3], 0, 2 // 3, -1 // 12, 0, 0, 0]'
...
q2 =
    [-q1[2], 0, 8.0515625504417e-01, -2.0755653563249e-01, 3.4573926056780e-02, 0, 0, 0, 0]'
q3 =
    [
        -q1[3],
        -q2[3],
...
q4 = [-q1[4], -q2[4], -q3[4], 0, 7.5629896626333e-01, -3 // 20, 1 // 60, 0, 0]'
