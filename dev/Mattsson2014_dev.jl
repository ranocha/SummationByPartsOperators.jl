...
m1 = [2386127 // 2177280 -515449 // 453600 -10781 // 777600 61567 // 1360800 6817 // 403200 -1069 //
                                                                                            136080 0 0 0 0]
m2 = [m1[2] 4756039 // 2177280 -1270009 // 1360800 -3751 // 28800 3067 // 680400 119459 //
                                                                                 10886400 0 0 0 0]
...
n1 = [4596181 // 1814400 -10307743 // 1814400 160961 // 43200 -535019 // 907200 109057 //
                                                                                1814400 -29273 //
                                                                                        604800 0 0 0 0]
n2 = [n1[2] 8368543 // 604800 -9558943 // 907200 2177057 // 907200 -11351 // 86400 204257 //
                                                                                   1814400 0 0 0 0]
...
q1 = reshape([0, 1547358409 // 2421619200, -422423 // 11211200, -1002751721 // 8717829120,
                 -15605263 // 484323840, 1023865 // 24216192, 291943739 // 21794572800,
                 -24659 // 2534400,
                 0, 0, 0, 0], 1, length(h))
q2 = reshape([-q1[2], 0, 23031829 // 62899200, 10784027 // 34594560,
                 2859215 // 31135104, -45982103 // 345945600, -26681 // 1182720,
                 538846039 // 21794572800,
                 0, 0, 0, 0], 1, length(h))
q3 = reshape([-q1[3], -q2[3], 0, 28368209 // 69189120,
                 -9693137 // 69189120, 1289363 // 17740800, -39181 // 5491200,
                 -168647 // 24216192,
                 0, 0, 0, 0], 1, length(h))
q4 = reshape([-q1[4], -q2[4], -q3[4], 0,
                 5833151 // 10644480, 4353179 // 69189120, 2462459 // 155675520,
                 -215471 // 10762752,
                 0, 0, 0, 0], 1, length(h))
q5 = reshape([-q1[5], -q2[5], -q3[5], -q4[5], 0, 7521509 // 13837824, -1013231 // 11531520,
                 103152839 // 8717829120,
                 0, 0, 0, 0], 1, length(h))
q6 = reshape([-q1[6], -q2[6], -q3[6], -q4[6], -q5[6], 0, 67795697 // 98841600,
                 -17263733 // 151351200,
                 1 // 60, 0, 0, 0], 1, length(h))
q7 = reshape([-q1[7], -q2[7], -q3[7], -q4[7], -q5[7], -q6[7], 0, 1769933569 // 2421619200,
                 -9 // 60, 1 // 60, 0, 0], 1, length(h))
q8 = reshape([-q1[8], -q2[8], -q3[8], -q4[8], -q5[8], -q6[8], -q7[8], 0,
...
m1 = reshape([4347276223 // 3736212480, -1534657609 // 1210809600, 68879 // 3057600,
                 1092927401 // 13076743680,
                 18145423 // 968647680, -1143817 // 60540480, -355447739 // 65383718400,
                 56081 // 16473600,
                 0, 0, 0, 0], 1, length(h))
m2 = reshape([m1[2], 42416226217 // 18681062400, -228654119 // 345945600,
                 -12245627 // 34594560,
                 -2995295 // 46702656, 52836503 // 691891200, 119351 // 12812800,
                 -634102039 // 65383718400,
                 0, 0, 0, 0], 1, length(h))
m3 = reshape([m1[3], m2[3], 5399287 // 4193280, -24739409 // 34594560,
                 7878737 // 69189120, -1917829 // 31449600, 39727 // 3660800,
                 10259 // 4656960,
                 0, 0, 0, 0], 1, length(h))
m4 = reshape([m1[4], m2[4], m3[4], 7780367599 // 3736212480,
                 -70085363 // 69189120, -500209 // 6289920, -311543 // 17962560,
                 278191 // 21525504,
                 0, 0, 0, 0], 1, length(h))
m5 = reshape([m1[5], m2[5], m3[5], m4[5],
                 7116321131 // 3736212480, -545081 // 532224, 811631 // 11531520,
                 -84101639 // 13076743680,
                 0, 0, 0, 0], 1, length(h))
m6 = reshape([m1[6], m2[6], m3[6], m4[6],
                 m5[6], 324760747 // 138378240, -65995697 // 49420800, 1469203 // 13759200,
                 -2 // 180, 0, 0, 0], 1, length(h))
m7 = reshape([m1[7], m2[7], m3[7], m4[7], m5[7], m6[7], 48284442317 // 18681062400,
                 -1762877569 // 1210809600,
                 27 // 180, -2 // 180, 0, 0], 1, length(h))
m8 = reshape([m1[8], m2[8], m3[8], m4[8], m5[8], m6[8], m7[8], 10117212851 // 3736212480,
...
r1 = reshape([0, -10882810591 // 5811886080, 398713069 // 132088320,
                 -1746657571 // 1162377216,
                 56050639 // 145297152, -11473393 // 1162377216, -38062741 // 1452971520,
                 30473 // 4392960,
                 0, 0, 0, 0], 1, length(h))
r2 = reshape([-r1[2], 0, -3720544343 // 830269440, 767707019 // 207567360,
                 -1047978301 // 830269440, 1240729 // 14826240, 6807397 // 55351296,
                 -50022767 // 1452971520,
                 0, 0, 0, 0], 1, length(h))
r3 = reshape([-r1[3], -r2[3], 0, -2870078009 // 830269440,
                 74962049 // 29652480, -12944857 // 30750720, -17846623 // 103783680,
                 68707591 // 1162377216,
                 0, 0, 0, 0], 1, length(h))
r4 = reshape([-r1[4], -r2[4], -r3[4], 0,
                 -727867087 // 276756480, 327603877 // 207567360, -175223717 // 830269440,
                 1353613 // 726485760,
                 0, 0, 0, 0], 1, length(h))
r5 = reshape([-r1[5], -r2[5], -r3[5], -r4[5],
                 0, -1804641793 // 830269440, 311038417 // 207567360,
                 -1932566239 // 5811886080,
                 7 // 240, 0, 0, 0], 1, length(h))
r6 = reshape([-r1[6], -r2[6], -r3[6], -r4[6], -r5[6], 0, -1760949511 // 830269440,
                 2105883973 // 1452971520,
                 -72 // 240, 7 // 240, 0, 0], 1, length(h))
r7 = reshape([-r1[7], -r2[7], -r3[7], -r4[7], -r5[7], -r6[7], 0, -1081094773 // 528353280,
                 338 // 240, -72 // 240, 7 // 240, 0], 1, length(h))
r8 = reshape([-r1[8], -r2[8], -r3[8], -r4[8], -r5[8], -r6[8], -r7[8], 0,
...
n1 = reshape([40833734273 // 10761070320, -162181998421 // 16397821440,
                 4696168417 // 521748864, -245714671483 // 68870850048,
                 2185939219 // 2869618752, -15248255797 // 114784750080,
                 345156907 // 12298366080, 6388381 // 1093188096,
                 0, 0, 0, 0], 1, length(h))
n2 = reshape([n1[2], 147281127041 // 5380535160, -3072614435609 // 114784750080,
                 320122985851 // 28696187520,
                 -768046031383 // 344354250240, 7861605187 // 14348093760,
                 -803762437 // 4251287040, 167394281 // 86088562560,
                 0, 0, 0, 0], 1, length(h))
n3 = reshape([n1[3], n2[3], 139712483333 // 4782697920, -1634124842747 // 114784750080,
                 90855193447 // 28696187520, -26412188989 // 38261583360,
                 668741173 // 1793511720, -132673781 // 2342545920,
                 0, 0, 0, 0], 1, length(h))
n4 = reshape([n1[4], n2[4], n3[4], 437353997177 // 43044281280,
                 -172873969321 // 38261583360, 34759553483 // 28696187520,
                 -98928859751 // 344354250240, 295000207 // 3587023440,
                 0, 0, 0, 0], 1, length(h))
n5 = reshape([n1[5], n2[5], n3[5], n4[5],
                 126711914423 // 21522140640, -520477408939 // 114784750080,
                 49581230003 // 28696187520, -99640101991 // 344354250240,
                 7 // 240, 0, 0, 0], 1, length(h))
n6 = reshape([n1[6], n2[6], n3[6], n4[6],
                 n5[6], 19422074929 // 2391348960, -772894368601 // 114784750080,
                 10579712849 // 4099455360,
                 -96 // 240, 7 // 240, 0, 0], 1, length(h))
n7 = reshape([n1[7], n2[7], n3[7], n4[7],
                 n5[7], n6[7], 456715296239 // 43044281280, -915425403107 // 114784750080,
                 676 // 240, -96 // 240, 7 // 240, 0], 1, length(h))
n8 = reshape([n1[8], n2[8], n3[8], n4[8], n5[8], n6[8], n7[8], 488029542379 // 43044281280,
                 -1952 // 240, 676 // 240, -96 // 240, 7 // 240], 1, length(h))
n9 = [0 0 0 0 7 // 240 -96 // 240 676 // 240 -1952 // 240 2730 // 240 -1952 // 240 676 //
                                                                                   240 -96 //
                                                                                       240]
n10 = [0 0 0 0 0 7 // 240 -96 // 240 676 // 240 -1952 // 240 2730 // 240 -1952 // 240 676 //
                                                                                      240]
