...
m1 =
    [2386127 // 2177280 -515449 // 453600 -10781 // 777600 61567 // 1360800 6817 // 403200 -1069 //
                                                                                           136080 0 0 0 0]
m2 = [m1[2] 4756039 // 2177280 -1270009 // 1360800 -3751 // 28800 3067 // 680400 119459 //
                                                                            10886400 0 0 0 0]
m3 =
    [m1[3] m2[3] 111623 // 60480 -555587 // 680400 -551339 // 5443200 8789 // 453600 0 0 0 0]
...
n2 = [n1[2] 8368543 // 604800 -9558943 // 907200 2177057 // 907200 -11351 // 86400 204257 //
                                                                              1814400 0 0 0 0]
n3 =
    [n1[3] n2[3] 4938581 // 453600 -786473 // 151200 1141057 // 907200 -120619 // 907200 0 0 0 0]
...
q1 = reshape(
    [
        0,
        1547358409 // 2421619200,
        -422423 // 11211200,
        -1002751721 // 8717829120,
        -15605263 // 484323840,
        1023865 // 24216192,
        291943739 // 21794572800,
        -24659 // 2534400,
        0,
        0,
        0,
...
m1 = reshape(
    [
        4347276223 // 3736212480,
        -1534657609 // 1210809600,
        68879 // 3057600,
        1092927401 // 13076743680,
        18145423 // 968647680,
        -1143817 // 60540480,
        -355447739 // 65383718400,
        56081 // 16473600,
        0,
        0,
        0,
...
r2 = reshape(
    [
        -r1[2],
        0,
        -3720544343 // 830269440,
        767707019 // 207567360,
        -1047978301 // 830269440,
        1240729 // 14826240,
        6807397 // 55351296,
        -50022767 // 1452971520,
        0,
...
r9 =
    [0 0 0 0 -7 // 240 72 // 240 -338 // 240 488 // 240 0 -488 // 240 338 // 240 -72 // 240]
...
n1 = reshape(
    [
        40833734273 // 10761070320,
        -162181998421 // 16397821440,
        4696168417 // 521748864,
        -245714671483 // 68870850048,
        2185939219 // 2869618752,
        -15248255797 // 114784750080,
        345156907 // 12298366080,
        6388381 // 1093188096,
        0,
        0,
        0,
...
n2 = reshape(
    [
        n1[2],
        147281127041 // 5380535160,
        -3072614435609 // 114784750080,
        320122985851 // 28696187520,
        -768046031383 // 344354250240,
        7861605187 // 14348093760,
        -803762437 // 4251287040,
        167394281 // 86088562560,
        0,
        0,
        0,
        0,
...
n3 = reshape(
    [
        n1[3],
        n2[3],
        139712483333 // 4782697920,
        -1634124842747 // 114784750080,
        90855193447 // 28696187520,
        -26412188989 // 38261583360,
        668741173 // 1793511720,
        -132673781 // 2342545920,
        0,
        0,
        0,
        0,
...
n4 = reshape(
    [
        ...
        n2[4],
        n3[4],
        437353997177 // 43044281280,
        -172873969321 // 38261583360,
        34759553483 // 28696187520,
        -98928859751 // 344354250240,
        295000207 // 3587023440,
        0,
        0,
        0,
        0,
...
n5 = reshape(
    [
        ...
        n3[5],
        n4[5],
        126711914423 // 21522140640,
        -520477408939 // 114784750080,
        49581230003 // 28696187520,
        -99640101991 // 344354250240,
        7 // 240,
        0,
        0,
        0,
...
n6 = reshape(
    [
        ...
        n4[6],
        n5[6],
        19422074929 // 2391348960,
        -772894368601 // 114784750080,
...
n7 = reshape(
    [
        ...
        n5[7],
        n6[7],
        456715296239 // 43044281280,
        -915425403107 // 114784750080,
        676 // 240,
        -96 // 240,
        7 // 240,
        0,
...
n9 =
    [0 0 0 0 7 // 240 -96 // 240 676 // 240 -1952 // 240 2730 // 240 -1952 // 240 676 // 240 -96 //
                                                                                             240]
